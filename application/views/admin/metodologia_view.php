        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left"  method="post" action="<?= base_url(''); ?>/admin/Metodologia/guardarMetodologia" novalidate>
                    <!--
                      <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      </p>
                      -->
                      <span class="section">Metodologías</span>
                      <?php 
                        if(!is_null($datosCarga)){
                          echo '<input type="text" id="id" name="id" value="'.$datosCarga[0]->metodologia_id .'" hidden="true">';
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Nombre" class="form-control col-md-7 col-xs-12" name="Nombre" placeholder="" required="required" type="text" data-validation-length="3-12" data-validation-error-msg="User name has to be an alphanumeric value (3-12 chars)" value="<?php echo (!is_null($datosCarga)) ? $datosCarga[0]->metodologia_nombre : '' ;?>">
                        </div>
                      </div>
                          ...
                          <table id="datatable-keytable" class="table table-striped table-bordered">
                            ...
                            if($Slide != NULL){ 
                              foreach ($Slide as $key) {
                                echo '<tr>';
                                  echo '<td>'.$key->metodologia_nombre.'</td>';
                                  echo '<td><img src="'.base_url('file/img').'/'.$key->metodologia_url.'" height="42" width="42"></td>';
                                  if ($key->estado_id == 1) {
                                    echo "<td>activo</td>";
                                  }
                                  else
                                  ...
                                  echo '<td><center><a href="'.base_url().'admin/ContenidoAdmin/metodologia/'.$key->metodologia_id.'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i> Editar</a></center></td>';
                                echo '</tr>';
                              }
                            }else{
                                    echo '<tr>';
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url(); ?>/admin/Home/upload/359/350/URL" class="dropzone" id="my-awesome-dropzone" ></form>
        </div>
        <div id="Alerta"></div>
