                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!--
                      ...
                      <!-- Small modal -->
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Imagen Grande</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             if($Slide != NULL){
                              foreach ($Slide as $key) {
                                echo '<tr>';
                                  ...
                                  echo '<td>'.$key->slide_subtitulo.'</td>';
                                  echo '<td><img src="'.base_url('file/img').'/'.$key->slide_url.'" height="42" width="42"></td>';
                                  echo '<td><img src="'.base_url('file/img').'/'.$key->slide_urlpeque.'" height="42" width="42"></td>';
                                  if ($key->estado_id == 1) {
                                    echo "<td>activo</td>";
                                  }
                                  else
                                  ...
                                  echo '<td><center><a href="'.base_url().'admin/ContenidoAdmin/slider/'.$key->slide_id.'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i> Editar</a></center></td>';
                                echo '</tr>';
                              }
                            }else{
                              echo '<tr>';
  ...
  <div class="modal fade bs-example-modal-sm2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url(); ?>/admin/Home/upload/405/594/URL2" class="dropzone" id="my-awesome-dropzone" ></form>
        </div>
        <div id="Alerta"></div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
