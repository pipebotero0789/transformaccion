<div class="container"> 
    <div class="clients-area center wow fadeInDown">
        <h2 class="naranja">Estilo de vida</h2>
    </div>
     <div class="row">
    ...
    <div class="row">
        <div class="container estilo">
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/72aPA0YWW_s?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/0S31c3dM_LI?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/B-0M29vcBPM?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/R_rTA63eGls?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div class="container estilo">
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/IyRptZpPlDQ?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/VELTqD5sA9Y?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/UpJnBFhoU1g?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/jBRCvls48DQ?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
        <div class="container estilo">
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
                <iframe src="https://www.youtube.com/embed/_CiajG8g_QI?ecver=1" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 videos">
